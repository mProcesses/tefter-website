...
<section class="section">
  <div class="wrapper">
    ...
    <ul class="feature-list">
      ...
      <li>ERP tokovi rada pretpostavljaju savršene ulaze i stabilne partnerske sisteme</li>
  ...
  <div class="wrapper">
    ...
    <div class="card-grid">
      ...
      <div class="card">
        ...
        <p><strong>Šta:</strong> Partner portal bez integracije pod tvojim domenom za tokove nabavke</p>
        <a href="{{ '/partner-edge/' | relative_url }}" class="arrow-link" style="display: inline-block; margin-top: 10px;">Istraži Partner Edge</a>
      </div>
    </div>
  </div>
</section>
  ...
  <div class="wrapper">
    <div class="cta-box">
      ...
      <div class="cta-buttons">
        ...
        <a href="{{ '/tefter-apps/' | relative_url }}" class="btn btn-secondary">Istraži aplikacije</a>
      </div>
    </div>
  </div>
</section>
