...
<section class="hero">
  <div class="wrapper">
    ...
    <div class="cta-buttons">
      <a href="/contact/" class="btn btn-primary">→ {% t global.book_demo %}</a>
      <a href="/platform/" class="btn btn-secondary">→ {% t global.see_product %}</a>
    </div>
  </div>
</section>
...
<section class="section">
  <div class="wrapper">
    ...
    <a href="/tefter-apps/" class="arrow-link" style="display: block; text-align: center; margin-top: 30px;">{% t home.see_all_modules %}</a>
  </div>
</section>
...
<section class="section">
  <div class="wrapper">
    <div class="cta-box">
      ...
      <div class="cta-buttons">
        <a href="/contact/" class="btn btn-primary">{% t global.book_demo %}</a>
        <a href="/platform/" class="btn btn-secondary">{% t global.explore_platform %}</a>
      </div>
    </div>
  </div>
</section>
